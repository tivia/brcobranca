    ...
    module Cnab400
      class Sicoob < Brcobranca::Remessa::Cnab400::Base
        ...
        def monta_header
          ...
          "01REMESSA01COBRANÇA#{''.rjust(7, ' ')}#{info_conta}#{empresa_mae.format_size(30).remove_accents}#{cod_banco}#{nome_banco}#{data_geracao}#{sequencial_remessa}#{complemento}000001"
        end
